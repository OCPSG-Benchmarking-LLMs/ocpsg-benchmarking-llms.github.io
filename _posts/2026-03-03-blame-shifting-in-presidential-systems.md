...
González-Bustamante, B. (2026). Blame Shifting in Presidential Systems: Ministerial Terminations’ Corrective Effect on Approval. *Public Opinion Quarterly, 90*(1), 96–117. [https://doi.org/10.1093/poq/nfaf061](https://doi.org/10.1093/poq/nfaf061).
...
The identification and causal inference strategy of the empirical analysis is based on IV regressions. Therefore, in addition to the endogenous variable *D* and the *k*-th vector, we incorporated an *m*-th vector of three instruments that, like most of the covariates, were operationalised considering the previous quarter: (i) ministers’ average age Z1; (ii) the square of ministers’ average age Z2 to control for non-linear effects; and (iii) the proportion of nonpartisan ministers Z3. The rationale for the selection of these instruments is associated with the identification strategy, which is summarised in the points below, following the logic of some IV designs identified by the literature and a causal structure based on a **directed acyclic graph (DAG)**.

![Abbreviated Causal Diagram of the Effect of Dismissals of Tainted Ministers on Presidential Approval](/assets/img/post/DAG_POQ_2026.jpg)